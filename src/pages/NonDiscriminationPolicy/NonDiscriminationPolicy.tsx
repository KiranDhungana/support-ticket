...
const NonDiscriminationPolicy = () => {
  ...
  const handleDownload = () => {
    ...
    link.href = '/policies/NonDiscriminationPolicy.pdf';
    link.download = 'NonDiscriminationPolicy.pdf';
    link.target = '_blank';
    link.click();
  };

  const handleOpenInNewTab = () => {
    window.open('/policies/NonDiscriminationPolicy.pdf', '_blank');
  };
      ...
      <Container size="xl" py="xl">
        <Stack gap="md" mb="xl">
          ...
          <Text size="lg" c="dimmed">
            West Carroll Parish School Board Non Discrimination Policy
          </Text>
        </Stack>
          ...
          <Stack gap="md">
            ...
            {pdfLoadError ? (
              ...
              <div style={{ 
                ...
                <iframe
                  src="/policies/NonDiscriminationPolicy.pdf#toolbar=1&navpanes=1&scrollbar=1"
                  width="100%"
                  height="100%"
